        ...
        <div className="col-12">
          <div className="card docs">
            ...
            <p>
              ...
              <b>http://localhost:3000/</b> to view the application. That is it, you may now start
              with the development of your application using the Sakai template.
            </p>
...
`}</code>
            ...
            <p>
              ...
              <span className="text-primary font-medium">{`(full-page)`}</span> groups the pages
            ...
            <ul className="line-height-3">
              ...
              <li>
                <span className="text-primary font-medium">demo/</span>: Contains demo related
              ...
              <li>
                <span className="text-primary font-medium">public/layout</span>: Assets used in
                layout such as a logo
              </li>
              <li>
                <span className="text-primary font-medium">styles/demo</span>: Styles used in demos
                only
              </li>
              <li>
                <span className="text-primary font-medium">styles/layout</span>: SCSS files of the
                core layout
              </li>
            </ul>
            <h5>Route Groups</h5>
            <p>
              ...
              <span className="text-primary font-medium">app/layout.tsx</span> file. It contains the
              style imports and layout context provider.
            </p>
            <pre className="app-code">
              <code>
                {`"use client"
...
`}
            ...
            <p>
              ...
              <span className="text-primary font-medium">app/{"(main)"}/</span> folder. Those pages
              use the <span className="text-primary font-medium">app/{"(main)"}/layout.tsx</span> as
              the root layout.
            </p>
            <pre className="app-code">
              <code>
...
`}
            ...
            <p>
              Only the pages that are using config sidebar wihout layout elements need to be defined
              under the <span className="text-primary font-medium">app/{"(full-page)"}/</span>{" "}
              folder. Those pages use the{" "}
              <span className="text-primary font-medium">app/{"(full-page)"}/layout.tsx</span> as
              the root layout.
            </p>
            <pre className="app-code">
              <code>
...
`}
            ...
            <p>
              ...
              <span className="text-primary font-medium">layout/context/layoutcontext.js</span>{" "}
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
            ...
            <h5>Menu</h5>
            <p>
              Main menu is defined at <span className="text-primary font-medium">AppMenu.js</span>{" "}
              file based on{" "}
              <a
            ...
            <p>
              ...
              <b>_variables.scss</b> file under layout folder. Saving the changes will be reflected
