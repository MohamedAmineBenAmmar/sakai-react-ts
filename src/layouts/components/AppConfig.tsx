...
import { AppConfigProps, LayoutConfig, LayoutState, AppConfigComponentRefrence } from "@/types";
import { LayoutContext } from "../context/layoutcontext";


const AppConfig = forwardRef<AppConfigComponentRefrence, AppConfigProps>((props, ref) => {
